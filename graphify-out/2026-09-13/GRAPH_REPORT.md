# Graph Report - FlareLobby  (2026-09-13)

## Corpus Check
- 197 files · ~261,249 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5434 nodes · 9710 edges · 346 communities (182 shown, 164 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 154 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a335f088`
...
## Communities (346 total, 164 thin omitted)
...
### Community 1 - "room.ts"
Cohesion: 0.06
Nodes (80): assertJoinCredentials(), AuthenticatedRoomActor, createWebSocketTags(), decodeBase64Url(), digestPassword(), encodeBase64Url(), getParticipantWebSocketTag(), getPrincipalWebSocketTag() (+72 more)

### Community 2 - "IMatchPoolDurableObject"
Cohesion: 0.11
Nodes (6): IMatchPoolDurableObject, MatchmakingTicketCancellationOptions, MatchmakingTicketCreationOptions, MatchmakingTicketMatchOptions, MatchmakingTicketRecord, MatchmakingTicketReservationOptions
...
Cohesion: 0.06
Nodes (40): compareStrings(), DEFAULT_PARTY_IDLE_TTL_MS, DEFAULT_PARTY_INVITE_TTL_MS, DEFAULT_PARTY_MAX_SIZE, EventRow, InviteRow, isNonEmptyString(), MatchPoolCancellationStub (+32 more)

### Community 5 - "RoomDurableObject"
Cohesion: 0.07
Nodes (11): assertActiveRoom(), closeWebSocketSafely(), createRoomSnapshotEvent(), deleteRoomState(), getDisconnectOperationId(), getWebSocketRoomId(), hasWebSocketProtocol(), normalizeWebSocketError() (+3 more)

### Community 6 - "cloudflare/src/index.ts"
Cohesion: 0.06
Nodes (56): FlareLobbyConfiguration, createInvitationCode(), createPasswordFingerprint(), CustomRoomCreationInput, CustomRoomCreationOptions, CustomRoomCreationResponse, CustomRoomCreationResult, CustomRoomJoinInput (+48 more)

### Community 7 - "observability.ts"
Cohesion: 0.10
Nodes (28): attachObservabilityHeaders(), FLARE_LOBBY_ANALYTICS_SAMPLED_HEADER, FLARE_LOBBY_CORRELATION_ID_HEADER, FLARE_LOBBY_LOG_SAMPLED_HEADER, FLARE_LOBBY_OBSERVABILITY_SCHEMA_VERSION, FLARE_LOBBY_OPERATION_HEADER, FLARE_LOBBY_REQUEST_ID_HEADER, FlareLobbyObservabilityAttributeValue (+20 more)
...
Cohesion: 0.07
Nodes (46): ClientCommandOptions, appendQueryValue(), createCreationBody(), createCustomRoom(), createCustomRoomApi(), createJoinBody(), CustomRoomJoinMethod, CustomRoomParticipantRole (+38 more)
...
Cohesion: 0.05
Nodes (49): assertCorsConfiguration(), assertCustomRoomConfiguration(), assertInputLimits(), assertMatchmakingPools(), assertObservabilityConfiguration(), consumeRateLimit(), consumeRoomCreationRateLimit(), consumeWebSocketMessageRateLimit() (+41 more)

### Community 15 - "security.ts"
Cohesion: 0.06
Nodes (57): authenticateDemoRpsRequest(), upgradeCustomRoomWebSocket(), authenticateGatewayRequest(), authenticateRequest(), createGatewayPrincipalEnvelope(), createSignedToken(), createTokenNonce(), decodeBase64Url() (+49 more)
...
Cohesion: 0.10
Nodes (40): ADR-0004, createMatchmakingPoolKey(), createMatchRoomConnection(), createRoomWebSocketUrl(), createTicket(), decodePathSegments(), findPoolConfiguration(), getMatchmakingTicketWebSocketRoute() (+32 more)
...
Cohesion: 0.10
Nodes (5): FlareLobbyWebSocketConnection, compactJsonObject(), freezeSnapshot(), isRetryableReconnectError(), RoomImpl
...
Cohesion: 0.06
Nodes (41): createRoomHandle(), compactJsonObject(), createMatchmakingApi(), createPoolPath(), createRequestId(), createTicketPath(), deepFreeze(), getCurrentSearchWidth() (+33 more)

### Community 25 - "RoomPersistence"
Cohesion: 0.04
Nodes (29): createRoomState(), deepFreeze(), NextAlarmRow, ParticipantRow, ProcessedCommandRow, assertActiveRoom(), assertInitializedRoom(), assertPlayerRole() (+21 more)

### Community 26 - "RoomIndexSync.ts"
Cohesion: 0.12
Nodes (18): CustomRoomIndexRecord, isJsonObject(), parseJsonObject(), parseJsonValue(), readIndexString(), requireJsonObject(), ROOM_INDEX_DELETE_OPERATION_KIND, ROOM_INDEX_UPSERT_OPERATION_KIND (+10 more)
...
Cohesion: 0.05
Nodes (45): FlareLobbyClient, FlareLobbyClientOptions, RoomReconnectOptions, MatchmakingJoinOptions, MatchmakingPoolReference, MatchmakingProgress, MatchmakingProgressListener, MatchmakingResult (+37 more)

### Community 29 - "normalizeTicketId"
Cohesion: 0.13
Nodes (10): invalidSequence(), isSafeTimestamp(), normalizeEventQuery(), normalizeNow(), normalizeSearchNow(), normalizeTicketId(), parseAfterSequence(), parseAfterSequenceFromMessage() (+2 more)
...
Cohesion: 0.13
Nodes (11): createMatchmakingMatchId(), MATCHMAKING_POOL_KEY_SEPARATOR, parseMatchRoomOptions(), captureErrorCode(), createGatewayPrincipal(), createInitializedPool(), errorCodeOf(), extractErrorCode() (+3 more)

### Community 32 - "createCustomRoom"
Cohesion: 0.11
Nodes (34): createCustomRoom(), createWebSocketUrl(), CustomRoomGatewayStub, getSnapshotInvitationCode(), isJsonObject(), isJsonValue(), isRoomParticipantRoleValue(), joinCustomRoom() (+26 more)
...
Cohesion: 0.07
Nodes (62): createMatchmakingPoolKey(), createMatchmakingRoomId(), createMatchPoolKey, createMatchRoomInitialization(), createMatchRoomRecord(), deepFreeze(), DEFAULT_MATCHMAKING_MATCH_MAX_ATTEMPTS, DEFAULT_MATCHMAKING_MATCH_MAX_RETRY_DELAY_MS (+54 more)
...
Cohesion: 0.07
Nodes (29): scripts, build, changeset, check:consumer, check:deploy, check:docs, check:esm, check:packages (+21 more)
...
### Community 49 - "client/test/party.test.ts"
Cohesion: 0.13
...
Cohesion: 0.13
Nodes (8): getMatchSettlementErrorCode(), getMatchSettlementRetryDelay(), isRetryableMatchSettlementError(), normalizePositiveSafeInteger(), createObservabilityContext(), createObservabilitySink(), normalizeSampleRate(), createRecordingSink()
...
### Community 61 - "GatewayPrincipalEnvelope"
Cohesion: 0.06
Nodes (31): IRoomDurableObject, readPositiveHeader(), ROOM_WEBSOCKET_ATTACHMENT_VERSION, RoomCloseOptions, RoomHostOperationOptions, RoomKickOptions, close(), kick() (+23 more)
...
Cohesion: 0.09
Nodes (23): @changesets/cli, @cloudflare/vitest-pool-workers, oxfmt, oxlint, devDependencies, @changesets/cli, @cloudflare/vitest-pool-workers, oxfmt (+15 more)
...
### Community 73 - "CustomRoomTransport"
Cohesion: 0.20
Nodes (5): ClientRequestOptions, ClientWebSocketOptions, CustomRoomTransport, MatchmakingTransport, PartyTransport
...
Cohesion: 0.06
Nodes (23): defineFlareLobby(), FlareLobbyGatewayWorker, MatchmakingMatchIntent, EnvWithoutD1, EnvWithoutRateLimits, Equal, ExampleApp, Expect (+15 more)
...
### Community 152 - "registerMatchResult"
Cohesion: 0.22
...
### Community 154 - "IMatchPool.ts"
Cohesion: 0.16
Nodes (5): MatchmakingMatchProcessingOptions, MatchmakingMatchResult, MatchPoolInitializationOptions, MatchPoolSnapshot, normalizeMatchResult()
...
### Community 227 - "isNonEmptyString"
Cohesion: 0.20
Nodes (18): asRecord(), findExistingMatch(), findExistingTeamMatch(), firstResultRow(), isFiniteNumber(), isNonEmptyString(), isNonNegativeSafeInteger(), isSafeInteger() (+10 more)

### Community 229 - "repository"
Cohesion: 0.67
...
Cohesion: 0.06
Nodes (21): createFlareLobbyClient(), FetchImplementation, WebSocketConstructor, fakeWebSocketConstructor, createClient(), webSocket, createClient(), readRequestError() (+13 more)

### Community 312 - "slides.md"
Cohesion: 0.17
Nodes (11): Client SDK の初期化, FlareLobby, できること, カスタムルーム, パッケージと役割, マッチメイキングとパーティー, ローカルで試す, 切断からの復帰とレーティング (+3 more)
...
### Community 320 - "isRatingResult"
Cohesion: 0.29
Nodes (8): compareStrings(), isRatingResult(), isRecord(), normalizeIdentifier(), normalizeMatchResultInput(), normalizePlayerIdList(), normalizeTeamMatchResultInput(), toRatingResult()
...
### Community 322 - "listMatchHistory"
Cohesion: 0.20
...
### Community 336 - "party-matchmaking.test.ts"
Cohesion: 0.50
...
## Knowledge Gaps
- **1870 isolated node(s):** `$schema`, `changelog`, `commit`, `fixed`, `linked` (+1865 more)
...
- **Why does `RoomDurableObject` connect `RoomDurableObject` to `room.ts`, `local-demo/src/index.ts`, `cloudflare/src/index.ts`, `client-integration.test.ts`, `websocket.test.ts`, `config.ts`, `security.ts`, `custom-room-list.ts`, `cloudflare/test/custom-room.test.ts`, `durable-objects.ts`, `MatchPoolDurableObject`, `RoomIndexSync.ts`, `GatewayPrincipalEnvelope`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `MatchPoolDurableObject` connect `MatchPoolDurableObject` to `IMatchPoolDurableObject`, `match-pool.ts`, `local-demo/src/index.ts`, `cloudflare/src/index.ts`, `.initialize`, `config.ts`, `party-matchmaking.test.ts`, `.processPendingMatches`, `durable-objects.ts`, `matchmaking-settlement.test.ts`, `normalizeTicketId`, `match-pool.test.ts`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `IRoomDurableObject` connect `GatewayPrincipalEnvelope` to `createCustomRoom`, `room.ts`, `RoomDurableObject`, `cloudflare/src/index.ts`, `durable-objects.ts`, `RoomPersistence`?**
