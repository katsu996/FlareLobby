/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: a34706c085b9d34f607c7fc8c1334206)
// Runtime types generated with workerd@1.20260804.1 2026-08-08 
interface __BaseEnv_Env {
	FLARE_LOBBY_DB: D1Database;
	FLARE_LOBBY_TOKEN_SECRET: string;
	FLARE_LOBBY_ROOMS: DurableObjectNamespace<import("./src/index").RoomDurableObject>;
	FLARE_LOBBY_MATCH_POOLS: DurableObjectNamespace<import("./src/index").MatchPoolDurableObject>;
	FLARE_LOBBY_RATE_LIMITS: DurableObjectNamespace<import("./src/index").RateLimitDurableObject>;
