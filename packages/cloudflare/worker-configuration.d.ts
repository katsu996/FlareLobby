/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 498d5ea1ffb29e4757154ee051d881da)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 
interface __BaseEnv_Env {
	FLARE_LOBBY_DB: D1Database;
	FLARE_LOBBY_TOKEN_SECRET: string;
	FLARE_LOBBY_ROOMS: DurableObjectNamespace<import("./src/dev-worker").RoomDurableObject>;
	FLARE_LOBBY_MATCH_POOLS: DurableObjectNamespace<import("./src/dev-worker").MatchPoolDurableObject>;
	FLARE_LOBBY_PARTIES: DurableObjectNamespace<import("./src/dev-worker").PartyDurableObject>;
	FLARE_LOBBY_PARTY_MEMBERSHIPS: DurableObjectNamespace<import("./src/dev-worker").PartyMembershipDurableObject>;
	FLARE_LOBBY_RATE_LIMITS: DurableObjectNamespace<import("./src/dev-worker").RateLimitDurableObject>;
	FLARE_LOBBY_ANALYTICS?: AnalyticsEngineDataset;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/dev-worker");
		durableNamespaces: "RoomDurableObject" | "MatchPoolDurableObject" | "RateLimitDurableObject" | "PartyDurableObject" | "PartyMembershipDurableObject";
	}
