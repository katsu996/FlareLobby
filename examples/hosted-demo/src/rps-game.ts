 ...
 * 公開デモ用のじゃんけん判定ロジックです。
 *
 * `examples/local-demo/src/rps-game.ts` からの抽出です。新しいゲームエンジンや
 * 公開 package は作らず、この例専用に複製しています。ルールを変更する場合は
 * local-demo 側と差分を確認してください。
 */
...
const RPS_RESULT_ID_PREFIX = "hosted-rps-result:";
